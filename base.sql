...
CREATE TABLE Configuration (
  DureMin         int4 NOT NULL, 
  DureeMax        int4 NOT NULL, 
...
ALTER TABLE Enchere ADD CONSTRAINT FKEnchere462703 FOREIGN KEY (idClient) REFERENCES Client (idClient);
ALTER TABLE DemandeRechargement ADD CONSTRAINT FKDemandeRec561574 FOREIGN KEY (idClient) REFERENCES Client (idClient);
ALTER TABLE Encherir ADD CONSTRAINT FKEncherir77814 FOREIGN KEY (idEnchere) REFERENCES Enchere (idEnchere);
ALTER TABLE Encherir ADD CONSTRAINT FKEncherir900186 FOREIGN KEY (idClient) REFERENCES Client (idClient);
ALTER TABLE CategorieDelete ADD CONSTRAINT FKCategorieD952076 FOREIGN KEY (idCategorie) REFERENCES Categorie (idCategorie);
